...
def main():
    ...
    zhihu_fetch_parser = subparsers.add_parser("zhihu-fetch", help="crawl zhihu questions of a topic by **selenium**")
    zhihu_fetch_parser.add_argument("tid", help="tid")
    zhihu_fetch_parser.set_defaults(func=zhihu_topic_sele)
